  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      <Head>
        ...
        <meta
          name="description"
          content="Portfolio of Im Mudau Phumula - Software Developer"
        />
      ...
      <div className="flex flex-col items-center justify-center py-10">
        ...
        <h2 className="text-lg font-semibold mb-8 text-gray-600 text-center">
          Software Developer
        </h2>
        ...
        <div className="mt-10 text-center mx-auto max-w-md px-4">
          ...
          <p className="text-gray-600 justify-center">
            I'm a passionate software developer with a strong foundation in both
            front-end and back-end technologies. My journey in software
            development started with a curiosity for building interactive
            websites using HTML, CSS, and JavaScript. Over the years, I've honed
            my skills in frameworks like Flutter for front-end development and
            SQL for back-end development. I strive to create efficient,
            scalable, and user-friendly applications that leave a positive
